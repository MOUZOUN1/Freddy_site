    ...
    <div class="bg-white rounded-lg shadow-md p-8">
        <form method="POST" action="{{ route('admin.langues.update', $langue) }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nomlangue"
                       value="{{ old('nomlangue', $langue->nomlangue) }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="codelangue"
                       value="{{ old('codelangue', $langue->codelangue) }}"
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="4"
                          class="w-full px-4 py-2 border rounded-lg @error('description') border-red-500 @enderror">{{ old('description', $langue->description) }}</textarea>
